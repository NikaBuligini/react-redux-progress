...
The [issue tracker](https://github.com/NikaBuligini/react-redux-progress/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/react-redux-progress.git
   # Navigate to the newly cloned directory
   cd react-redux-progress
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/NikaBuligini/react-redux-progress.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/NikaBuligini/react-redux-progress/blob/master/LICENSE.md).
